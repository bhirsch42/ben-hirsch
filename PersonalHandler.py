...
def login():
	user = "benhirsch42"
	passwd = "diagonalelectrodiligentpantry"
...
class PersonalHandler(Handler):
	def get(self):
		...
		self.render("personal.html", multi_tab = multi_tab, xkcd_title = xkcd[0], xkcd_img = xkcd[1],
			tsquare_titles = gmail_tsquare[0], tsquare_summaries = gmail_tsquare[1], show_titles = show_data[0],
			show_links = show_data[1], show_times = show_data[2])
